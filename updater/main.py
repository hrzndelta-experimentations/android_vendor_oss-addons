...
update_if_needed('Fennec', fdroid_recommended_release(fdroid_main_repo, 'org.mozilla.fennec_fdroid'))
update_if_needed('Gramophone', fdroid_recommended_release(fdroid_main_repo, 'org.akanework.gramophone'))
update_if_needed('HeliBoard', fdroid_recommended_release(fdroid_main_repo, 'helium314.keyboard'))
update_if_needed('Lawnicons', fdroid_recommended_release(fdroid_izzy_repo, 'app.lawnchair.lawnicons'))
update_if_needed('ProtonVPN', fdroid_recommended_release(fdroid_main_repo, 'ch.protonvpn.android'))
